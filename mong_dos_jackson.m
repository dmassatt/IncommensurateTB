...
E_range = 4; % currently targets a range encorporating all monolayer dos energies
E_scale = 4.5; % Rescale of energy for Chebyshev
...
v(1) = 1;
H = Generate_MonG(L,1); 
cheb_wgts=Cheb_LDoS_Weights(H, E_scale, v, p-1);
